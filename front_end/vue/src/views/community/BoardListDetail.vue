<template>
  <div>
    <h1 style="margin-top:50px">Detail</h1>
    <div class="card text-black bg-white mb-3" style="max-width: 150rem; margin-left:300px; margin-right:300px; margin-top:50px;">
      ...
      <div class="card-body">
        ...
        <p class="card-text comment-card1" > name : {{ boardDetail.username }} </p>
        <p class="card-text comment-card1" > content : 
                  ...
                  <div class="card-body">
                      ...
                      <div class="d-flex mb-4">
                        <div v-for="(comment, idx) in comments" :key="idx">
                          <div class="flex-shrink-0"><img class="square" src="https://dummyimage.com/50x50/ced4da/6c757d.jpg" alt="..." /></div>
                          <div class="ms-3">
